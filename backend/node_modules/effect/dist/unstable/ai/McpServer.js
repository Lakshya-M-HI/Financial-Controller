...
import { CallToolResult, ElicitationDeclined, EnabledWhen, GetPromptResult, Initialize, InternalError, InvalidParams, InvalidRequest, isParam, McpServerClient, McpServerClientMiddleware, MethodNotFound, Ping, Prompt, Resource, ResourceTemplate, ServerNotificationRpcs, TextContent, Tool as McpTool, ToolJsonSchema } from "./McpSchema.js";
        ...
        if (message.tag.includes("list_changed")) {
          if (!listChangedHandles.has(message.tag)) {
            listChangedHandles.set(message.tag, setTimeout(() => {
              Queue.offerUnsafe(notificationsQueue, {
                notification
              });
...
const runWithProtocolState = /*#__PURE__*/Effect.fnUntraced(function* (options, protocolState) {
  ...
  yield* Queue.take(internalState.get(server).notifications).pipe(Effect.flatMap(Effect.fnUntraced(function* ({
    notification,
    targetClientId
  }) {
