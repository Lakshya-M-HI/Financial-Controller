 ...
 */
export type FrameworkBuildType = "nextjs" | "nuxt" | "astro" | "nestjs" | "tanstack-start" | "custom" | "bun";
...
export declare const FRAMEWORK_KEYS: ("nextjs" | "nuxt" | "astro" | "hono" | "nestjs" | "tanstack-start" | "custom" | "bun")[];
/** Build types whose preview build consumes committed build settings. */
export declare const CONFIG_BACKED_BUILD_TYPES: readonly ["nextjs", "nuxt", "astro", "nestjs", "tanstack-start", "custom", "bun"];
 ...
 */
export declare function defaultHttpPortForBuildType(buildType: FrameworkBuildType): number;
