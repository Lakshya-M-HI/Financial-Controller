 ...
 */
export declare const COMPUTE_FRAMEWORKS: readonly ["nextjs", "nuxt", "astro", "hono", "nestjs", "tanstack-start", "custom", "bun"];
export type ComputeFramework = (typeof COMPUTE_FRAMEWORKS)[number];
/** Supported Compute region identifiers. */
export declare const COMPUTE_REGIONS: readonly ["us-east-1", "us-west-1", "eu-west-3", "eu-central-1", "ap-northeast-1", "ap-southeast-1"];
 ...
 */
export type ComputeConfig = (ComputeConfigDefaults & {
 ...
 * ```
 */
export declare function defineComputeConfig(config: ComputeConfig): ComputeConfig;
