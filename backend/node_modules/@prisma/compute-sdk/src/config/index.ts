...
export {
  type DetectComputeRepositoryInput,
  type DetectComputeRepositoryResult,
  type DetectedComputeRepositoryApp,
  detectComputeRepository,
} from "./detect-repository.ts";
export {
